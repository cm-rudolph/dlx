...
class DlxTest {
    ...
    void matrixFromFigure3ofPaper_solvedCorrectly() {
        Dlx<String> dlx = new Dlx<>(7, Collections.emptySet(), -1, 1, 10, false, Integer.MAX_VALUE);
    ...
    void matrixWithSecondaryConstraint_constraintNotFulfillable_solvedCorrectly() {
        Dlx<String> dlx = new Dlx<>(8, Collections.singleton(7), -1, 1, 10, false, Integer.MAX_VALUE);
        dlx.addChoice("C E F", listOf(2, 4, 5));
